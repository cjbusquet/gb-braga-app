/**
 * Generic KPI/table report PDF rendering + the predefined report builders,
 * using jsPDF. Runs entirely client-side, no server required.
 */
...
export function exportRelatorioFinanceiro(pagamentos: PagamentoResumo[]): void {
...
export function exportRelatorioAlunos(alunos: AlunoResumo[]): void {
  exportPDF({
