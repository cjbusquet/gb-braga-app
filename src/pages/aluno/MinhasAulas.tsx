        ...
        >
          ...
          >
            <div style={{ textAlign: 'center' as const }}>
              <div style={{ color: GB.red, fontSize: 26, fontWeight: 700 }}>
            ...
            <div style={{ textAlign: 'center' as const }}>
              <div style={{ color: '#22C55E', fontSize: 26, fontWeight: 700 }}>
                {aluno.frequencia}%
              </div>
              <div style={{ color: 'var(--text-muted)', fontSize: 10.5 }}>
                frequência
          ...
          >
            <div
              style={{
                background: aluno.frequencia >= 80 ? '#22C55E' : GB.red,
                height: '100%',
                width: `${Math.min(aluno.frequencia, 100)}%`,
              }}
            />
          </div>
